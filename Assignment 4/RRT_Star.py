...
from graph import Graph, Star_Graph, Node, Car, MyMath
...
def RRT_Star():
    ...
    while(count < MAX_ITTERATIONS):
        ...
        # RRT star shine time
            ...
            g_star.update_graph(g)
            nearest_node = g_star.get_best_node(node)

        # check that the node is valid node then add it
